...
public class Exercise4Fragment extends BaseFragment {
    ...
    private static int MAX_TIMEOUT_MS = DefaultConfiguration.DEFAULT_FACTORIAL_TIMEOUT_MS; // safe

    private final Handler mUiHandler = new Handler(Looper.getMainLooper()); //safe
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mBtnStartWork.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int argument = Integer.parseInt(mEdtArgument.getText().toString());
